...
internal sealed class UpdateCouponCommandValidator : AbstractValidator<UpdateCouponCommand>
{
    private static readonly string[] ValidTypes = Enum.GetNames<CouponType>();
